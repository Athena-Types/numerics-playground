...
x4 = float<ieee_64,zr>(Mx4);
x5 = float<ieee_64,zr>(Mx5);
x6 = float<ieee_64,zr>(Mx6);

Mex0 = (((((Mx2 * Mx5) + (Mx3 * Mx6)) - (Mx2 * Mx3)) - (Mx5 * Mx6)) + (Mx1 * (((((-Mx1 + Mx2) + Mx3) - Mx4) + Mx5) + Mx6)));

ex0 float<ieee_64,zr>= (((((x2 * x5) + (x3 * x6)) - (x2 * x3)) - (x5 * x6)) + (x1 * (((((-x1 + x2) + x3) - x4) + x5) + x6)));
