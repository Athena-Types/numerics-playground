x0p = float<ieee_64,ne>(Mx0p);
x0n = float<ieee_64,ne>(Mx0n);
...
pos float<ieee_64,ne>= ((((x0p + x1p) + x2n) + ((x1p + x2p) + x0n)) + ((x2p + x0p) + x1n));
neg float<ieee_64,ne>= ((((x0n + x1n) + x2p) + ((x1n + x2n) + x0p)) + ((x2n + x0n) + x1p));
