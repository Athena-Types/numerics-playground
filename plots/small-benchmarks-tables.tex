...
\midrule
add-assoc & 2.67e-15 (1.0$\times$) & 1.78e-15 (1.5$\times$) & \textbf{1.22e-15 (2.2$\times$)} & 1.33e-15 (2.0$\times$) \\
...
test01\_sum3 & 2.67e-14 (1.0$\times$) & 1.33e-14 (2.0$\times$) & 6.66e-15 (4.0$\times$) & \textbf{4.44e-15 (6.0$\times$)} \\
\bottomrule
\end{tabular}
\end{table}
