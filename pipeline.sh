...
parallel -j $PARALLEL_JOBS $BASH bench_large.sh {1} {2} $BENCH_PHASE $TIMEOUT $MEMORY_LIMIT $CPU_LIMIT ::: horner matmul serialsum poly ::: 4 8 16 32 64 128 256 512 1024 2048
