...
\title[Fixed Fuzz]{Fixed Fuzz: A Type-Based Approach to Roundoff Error
Analysis For Fixed-Point Programs}
...
\keywords{linear type systems, verification, round-off error, fixed point}
