...
assume that there is no underflow or overflow in the program. We do not support
...
competitive error bounds, (2) achieves good performance, and (3) benefits from
