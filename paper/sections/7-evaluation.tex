...
competing tools on benchmarks in the FPBench benchmark suite \cite{fpbench}
...
of magnitude faster than Gappa and FPTaylor.
...
significantly faster than competing approaches, often outperforming by an order
of magnitude. 
...
\paragraph{The \textbf{factor} primitive results in tighter error bounds and low
