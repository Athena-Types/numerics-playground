...
Each column represents a set of paramterized benchmarks. The top row represents
...
Moreover using \textbf{factor} only improved the monadic grade while keeping the
bound analysis the same.
