...
For example, consider the pairwise summation algorithm which will recursively a
...
error bound, reducing the error of our running example by approximately
one-third from $2.6645352591003757 \times 10^{-15}$ to $1.7763568394002505
\times 10^{-15}$.
