...
cancelation} and forms one of the primary technical obstacles to verifying our
running example. 
...
To understand the problem posed by an infintely-sensitive operation, consider
our running example:
