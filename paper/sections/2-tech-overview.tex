...
example below. Through our motivating example, we overview our extensions.
...
In our running example, we have that $x \in [-1, 1] \times [0, 1] \times [0, 1]$
and $y \in [-1, 1] \times [0, 1] \times [0, 1]$. 

The bounds analysis in our type inference algorithm will assign the type 
