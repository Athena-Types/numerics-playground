...
components of the pair are always-growing. This avoids the problem of
catestrophic cancellation in the paired representation.
...
we can encode subtraction in a finitely-sensitive manner. 
