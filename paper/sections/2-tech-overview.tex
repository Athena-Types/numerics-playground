...
the inferred grade of the monad and is therefore no looser than the bound
obtained by Numerical Fuzz. Negative Fuzz is therefore a strict improvement on
Numerical Fuzz: our approach can analyze more programs with possibly tighter
bounds on previously supported programs.
