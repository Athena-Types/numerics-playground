...
Therefore, we have that our example program has infinitely-bounded error, which
is not a useful error bound.
...
subtraction have finitely-bounded sensitivity. The trick is to associate for
each real $r \in \mathbb{R}$ a triple $(r, a, b) \in \mathbb{P} = \mathbb{R}
