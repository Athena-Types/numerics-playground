...
Simplifying for presentational purposes, we can obtain bounds on $r$ by extending the type system to be able to perform
...
We present a more sophisticated version of the above example in this paper.
