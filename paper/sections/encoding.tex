...
\begin{proof}
  ...
  bound.
  We finally observe the bounds if $r' < 0$ and $r' > 0$ produce the same
  bounds.
  \begin{enumerate}
    \item[(1)] $max(|ln(e^{q} + \frac{a^{\uparrow}}{r'}(1-e^{2q}))|, |ln(e^{q} + \frac{a^{\downarrow}}{r'}(1-e^{2q}))|)$
    \item[(2)] $max(|ln(e^{q} + \frac{b^{\uparrow}}{r'}(e^{2q}- 1))|,|ln(e^q + \frac{b^{\downarrow}}{r'}(e^{-2q}-1))|)$
  \end{enumerate}
\end{proof}
