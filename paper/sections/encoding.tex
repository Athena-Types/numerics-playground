...
with error on $r$. By plugging in Theorem~\ref{thm:paired-a-posteriori-rel} and
Theorem~\ref{thm:paired-a-priori-rel}, proved below, we are able to obtain multiple
...
\begin{theorem}[Paired error theorem; a priori relative] \label{thm:paired-a-priori-rel}
  ...
  following bounds: 
\begin{enumerate}
  \item $max(|ln(e^{q} + \frac{a}{a-b}(e^{-q}- e^{q}))|, |ln(e^{-q} + \frac{a}{a-b}(e^{q}- e^{-q}))|)$
  \item $max(|ln(e^q + \frac{b}{a-b}(e^q - e^{-q}))|,|ln(e^q + \frac{b}{a-b}(e^{-q} - e^{q}))|)$
\end{enumerate} 
\end{theorem} 
\begin{proof}
  ...
  \begin{aligned}[c]
    |ln(\frac{r'}{r})| \leq 
    |ln(\frac{a' - be^q}{a - b})| =
    |ln(\frac{a' - be^q + ae^q - ae^q}{a - b})| \\ =
    |ln(e^q + \frac{a' - ae^q}{a - b})| \leq
    |ln(e^q + \frac{ae^{-q} - ae^q}{a - b})| =
    |ln(e^q + \frac{a}{a - b}(e^{-q} - e^q))|
  \end{aligned}
  \end{equation}
...
\begin{proof}
  ...
  $d_{\mathbb{R}}(a, a'), d_{\mathbb{R}}(b, b') \leq q$. Unfolding the
  definition of $d_\mathbb{R}$, which uses relative error, we wish to bound
  $|ln(\frac{r}{r'})| = |ln(\frac{a - b}{a' - b'})|$. We proceed to prove the
  first bound:
...
\begin{theorem}[Paired error theorem; a priori absolute] \label{thm:paired-a-priori-abs}
  For $. \vdash e : M_q~\mathbf{num}_{(k_0, k_1)}$, $e \mapsto ((r, a, b), (r',
  a', b'))$ where $|r - r'|$ is the maximum of the following
\begin{enumerate}
\end{enumerate} 
\end{theorem} 
\begin{proof}
...
\begin{theorem}[Paired error theorem; a posterori absolute] \label{thm:paired-a-priori-abs}
  For $. \vdash e : M_q~\mathbf{num}_{(k_0, k_1)}$, $e \mapsto ((r, a, b), (r',
  a', b'))$ where $|r - r'|$ is the maximum of the following
\begin{enumerate}
\end{enumerate} 
