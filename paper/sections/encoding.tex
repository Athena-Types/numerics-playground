...
Recall that we assume that $r$ and $r'$ are non-zero and share the same sign.
% todo: mention this earlier probably
...
\begin{theorem}[Paired error theorem; a priori relative] \label{thm:paired-a-priori-rel}
  ...
  \begin{enumerate}
    ...
    \item $r^{\downarrow} \leq r \leq r^{\uparrow}$
    \item $a^{\downarrow} \leq a \leq a^{\uparrow}$
    \item $b^{\downarrow} \leq b \leq b^{\uparrow}$
  \end{enumerate}
...
\begin{theorem}[Paired error theorem; a posterori absolute] \label{thm:paired-a-priori-abs}
  For any numbers $((r, a, b), (r', a', b')) \in \mathbb{P}^2$ and where we have
  $a^{\downarrow}, a^{\uparrow}, b^{\downarrow}, b^{\uparrow} \in \mathbb{R}^{+}$
  and the following bounds for $r^{\downarrow}, r^{\uparrow} \in \mathbb{R}$, 
  \begin{enumerate}
    \item $d_{\mathbb{R}}(a, a'), d_{\mathbb{R}}(b, b') \leq q$
    \item $r^{\downarrow} \leq r \leq r^{\uparrow}$
    \item $a^{\downarrow} \leq a \leq a^{\uparrow}$
    \item $b^{\downarrow} \leq b \leq b^{\uparrow}$
  \end{enumerate}
  and we know $r'$, we have that $|r - r'|$ is the maximum of the following:
% \begin{enumerate}
% \end{enumerate} 
\end{theorem} 
\begin{proof}
