...
representation} where we associate for each real $r \in \mathbb{R}$ a triple
$(r, a, b) \in \mathbb{P} = \mathbb{R} \times \mathbb{R}^+ \times \mathbb{R}^+ =
\mathit{num}$ such that $r = a - b$. To soundly use our encoding, we must show
it satisfies the correctness properties demanded by the modular interface
defined in Section~\ref{sec:lang}.
