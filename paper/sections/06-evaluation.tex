...
\begin{enumerate}
  ...
  $$\Gamma; e^{\bnd{\bullet}}; \tau^{\bnd{\bullet}} \underset{bnd.}{\implies}
  \Gamma; e'; \tau'$$
\end{enumerate}
The full type inference algorithm is $\implies \triangleq
\underset{bnd.}{\implies} \circ \underset{sens.}{\implies}$, defined below.

\subsubsection{Stage 1/2: Sensitivity inference} \label{sec:sen-type-infer}
...
\AXC{$\Gamma; e^{\bnd{\bullet}} \implies \Gamma; e; \tau_0$}
\AXC{$\Gamma, x; f^{\bnd{\bullet}} \implies \Theta, x :_s \tau_0; \tau$}
...
e; \tau_0 \otimes \tau_1$}
\AXC{$\Gamma, x, y; f^{\bnd{\bullet}} \implies \Delta_1 \ | \ \Theta, x :_s
\tau_0, y :_s \tau_1; f; \tau$}
...
\AXC{$\Gamma, x; f^{\bnd{\bullet}} \implies \Theta, x :_s \tau_0; M_q~\tau$}
