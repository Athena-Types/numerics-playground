...
corresponding to the iterative summation algorithm on four numbers. In
...
u} \ \textbf{num}$, lower than the $3 \cdot u$ error grade of the iterative
summation program.
\begin{figure}
  \scriptsize
  \centering
...
\end{figure}
As \textbf{add} and \textbf{sub} have the same type, the same processes of
