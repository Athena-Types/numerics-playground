...
maximum error introduced by the function. By simultaneously bounding these two
properties, Numerical Fuzz is able to compositionally bound the maximum
...
We demonstrate how to encode subtraction as a finitely-sensitive operation.
...
We can encode our operations, including subtraction, in this representation in a
...
the paired represenation, (2) measure error on the paired represenation, and (3)
...
functions via \textit{bound polymophism}, which allows functions to be
...
terms. Unfortuantely, Numerical Fuzz is not capable of distinguishing between
...
% TODO: provide op sem interpretation (reassoc'ing error tersm)?
...
\begin{itemize}
  ...
  \item We implement our type-based approach for error analysis. 
    ...
    When compared against FPTaylor and Gappa and Satire on a suite of benchmarks
    translated into our core language, we obtain useful and competitive error
    bounds with faster and more scalable performance (Section~\ref{sec:eval}).
