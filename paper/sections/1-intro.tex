...
often time-out or fail to produce usable error bounds on large programs.
...
% twhich more accurately
% captures the categorical semantics of our graded monad introduced in Numerical
% Fuzz \cite{numfuzz}. We prove that our primitive is type-sound and show how to
% use the primitive in Section~\ref{sec:structure}.
