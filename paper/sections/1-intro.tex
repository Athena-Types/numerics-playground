...
global optimization \cite{fptaylor} \cite{satire}, rewrite saturation
\cite{gappa}, or SMT-based methods \cite{rosa}. However these approaches
frequently time-out on large programs. Type-based techniques offer an
alternative approach that is inherently compositional and scalable: all of the
