...
Our paired represenation associates each possibly negative real $r$ in our
...
functions to be polymorphic in the bounds assigned to the inputs. To reduce the
user type annotation burden, we also provide a type inference algorithm that can
