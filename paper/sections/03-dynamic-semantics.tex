...
\begin{definition}[Enviroment compatibility]
  ...
  \begin{equation}
    \begin{aligned}[c] 
      ...
      % comonad case
      \sigma \textit{ \underline{com} } \Gamma, x:_t !_s \tau \textit{ \underline{at} } (\alpha, p) \textit{ \underline{in} } (d, Y) \times D_s ((d_x, X)) &\triangleq 
      \sigma \textit{ \underline{com} } \Gamma, x :_{s * t} \tau \textit{ \underline{at} } \alpha \textit{ \underline{in} } (d, Y) \times (d_x, X) \\
      % monad case
      ...
      & \text{ and } p, q \in X \\
      % unit case
      \sigma[x \mapsto * :_s \tau] \textit{ \underline{com} } \Gamma, x:_s \textbf{unit} \textit{ \underline{at} } (\alpha, *) \textit{ \underline{in} } (d, X) \times (d_x, \{ * \}) &\triangleq 
