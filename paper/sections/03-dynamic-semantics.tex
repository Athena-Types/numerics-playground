...
\end{equation*}
    ...
    \sigma_1 \Vdash \textbf{let-bind}_{(s, \tau')} \ x = e \ \tin \ f  : M_{s*r
    + q} \ \tau \rightsquigarrow \mu (\gamma_n, \sigma_0 [x \mapsto v_n :_s
    \tau'];...; \gamma_0, \sigma_0 [x \mapsto v_0 :_s \tau'] \Vdash f : M_{s *
    r} (M_q \tau))$}
    \DisplayProof
