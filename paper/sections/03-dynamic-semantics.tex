...
\end{equation*}
    ...
    \sigma_1' \Vdash (v_0, v_1) : M_r \tau'$} 
    \UIC{ $\sigma_0 + \sigma_1 \Vdash \textbf{let-bind}_{(s, \tau')} \ x = e \
    \tin \ f  : M_{s*r + q} \ \tau \rightsquigarrow \mu (\sigma_1' + \sigma_0 [x
    \mapsto v_1 :_s \tau']; \sigma_1' + \sigma_0 [x \mapsto v_0 :_s \tau']
    \Vdash f : M_{s * r} (M_q \tau))$}
    \DisplayProof
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \vskip 0.3em
    \AXC{$\sigma \Vdash e_0 : \tau_0 \rightsquigarrow \sigma_0 \Vdash e_0':
    \tau_0$}
    \AXC{$\sigma \Vdash e_1 : \tau_1 \rightsquigarrow \sigma_1 \Vdash e_1' :
    \tau_1$}
    \BIC{$\sigma \Vdash \langle e_0, e_1 \rangle \ : \tau_0 \times \tau_1
    \rightsquigarrow \sigma_0 + \sigma_1 \Vdash \langle e_0', e_1' \rangle:
    \tau_0 \times \tau_1$}
    \DisplayProof
