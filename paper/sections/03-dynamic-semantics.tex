...
\end{equation*}
    ...
    v^0;...;v^n: \ !_s \tau'$}
    \UIC{ $\sigma + \sigma' \Vdash \textbf{let-cobind}_{(s, t, \tau')} \ x = e \
    \tin \ f : \tau \rightsquigarrow \sigma'[x \mapsto v^0 :_{t * s} \tau'] ...
    \sigma'[x \mapsto v^n :_{t * s} \tau'] \Vdash f : \tau$}
    \DisplayProof
    ...
    v^0;...; v^n : \tau'$}
    \UIC{ $\sigma + \sigma' \Vdash \textbf{let}_{(s, \tau')} \ x = e \ \tin
    \ f  : M_{q} \tau \rightsquigarrow \sigma'[x \mapsto v^0 :_s \tau']; ...;
    \sigma'[x \mapsto v^n :_s \tau']
    \Vdash f : M_q \tau$}
    \DisplayProof
    ...
    \vskip 0.3em
    \AXC{$\frac{1}{s} \cdot \sigma \Vdash e : \tau' \rightsquigarrow^*
    (v_0^0, v_1^n);...; (v_0^n, v_1^n) : \tau' \tensor \tau''$}
    \UIC{ $\sigma + \sigma' \Vdash \textbf{let-pair}_{(s, \tau', \tau'')} \ (x, y) = e \ \tin
    \ f  : \tau \rightsquigarrow \linebreak
    \sigma'[x \mapsto v_0^0 :_s \tau', y \mapsto v_1^0 :_s \tau'']; ...;
    \sigma'[x \mapsto v_0^n :_s \tau', y \mapsto v_1^n :_s \tau'']
    \Vdash f : \tau$}
    \DisplayProof
    ...
    \rightsquigarrow (v_0^0;...;v_0^n) \times (v_1^0;...;v_1^n) : \tau_0 \times \tau_1$}
    \DisplayProof
    ...
    \rightsquigarrow (v_0^0;...;v_0^n) \times (v_1^0;...;v_1^n) : \tau_0 \tensor \tau_1$}
    \DisplayProof
