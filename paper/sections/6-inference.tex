...
\begin{enumerate}
  ...
  \item We compute our interval operations via $\llbracket - \rrbracket$. The output of bound inference may
...
combined algorithm where the sensitivities and bounds are inferred in one pass.
...
\begin{description}
  ...
  \item[$\multimap$ E.] By our inductive hypothesis, we know that there exist
    ...
    \cdots \{i_n\}) e' : \tau[\epsilon_0 / i_0, \ldots, \epsilon_n / i_n]$ which completes the case.
