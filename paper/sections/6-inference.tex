...
equality check for soundness.\footnote{%
  Both the $I$ and $E$ helper functions are fully
defined in the appendix in Figure~\ref{fig:helper_type_inference}.}
The \textbf{factor} case is new but straightforward.
