...
\begin{definition}[Sensitivity erasure]
  ...
  a fully erased typing context $\Gamma^{\bnd{\bullet}} = \Gamma \circ \pi_2$
  with all sensitivity information erased and only returning the type.
\end{definition}
...
following cases to deal with bounds and bound polymorphism.
$$
\begin{aligned}[c]
