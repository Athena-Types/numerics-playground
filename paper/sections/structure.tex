...
\begin{theorem}[Factorization soundness]
  For any program $. \vdash e : \tau$ and $e' = \textsc{factorize} \ e \
...
\begin{proof}
  ...
  We strengthen the inductive hypothesis with the assumption that: $\sigma:
  \text{var} \rightharpoonup \text{program}$ only maps variables $x_0, x_1, x_n$
  defined in the typing context $\Gamma$ such that $\Gamma \vdash \sigma[x] :
  M_u \ \Gamma[x]$ is well-typed and TODO.
  \begin{description}
