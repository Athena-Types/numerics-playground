...
instantiation $\bnd{(e \{i\})}$. This is useful for incorporating a interval
analysis into the type system, which we detail in the following section.
...
define pair and context summing and scaling formally below.
