...
In Section\ref{sec:encoding}, we will instantiate our family of languages with a
...
We first describe the syntax (Section~\ref{sec:syntax}), static semantics
...
is proved sound in Theorem~{\ref:metric-preservation}). $\textbf{factor}$ is a particularly useful primitive to have for
