...
\begin{proof}
  ...
  % TODO: flesh this out some more, spell it out.
\end{proof}
...
\begin{description}
  ...
  \item[$\multimap$ E.] By our inductive hypothesis, we know that there exists:
    \begin{itemize}
      \item a derivation $d_0$ where $\Delta' \ | \ \Gamma' \vdash f : \forall
        \epsilon_0, \cdots, \epsilon_n, \tau_0 \multimap \tau$
      \item a derivation $d_1$ where $\Delta'' \ | \ \Theta \vdash e : \tau_0'$.
    \end{itemize}
    ...
    By weakening, we have a derivation for $\Delta \ | \ \Theta \vdash e :
