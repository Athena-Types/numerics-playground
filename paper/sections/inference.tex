...
\AXC{}
\RightLabel{(Unit)}
\UIC{$\Gamma^{\bullet}; \langle \rangle^{\bnd{\bullet}}; \underset{bnd.}{\implies} \Gamma^{0};
...
\AXC{}
\RightLabel{(Var)}
\UIC{$\Gamma^{\bullet}, x : \tau, x^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma^{0}, x
:_1 \tau; x; \tau$}
\bottomAlignProof
\DisplayProof
\vskip 1em
...
\AXC{}
\RightLabel{(Const)}
\UIC{$\Gamma^{\bullet}; k^{\bnd{\bullet}}; \underset{bnd.}{\implies} \Gamma^{0};
k; \textbf{num}_{\bnd{inj(k)}}$}
\bottomAlignProof
\DisplayProof
\hskip 0.5em
%% bang intro
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma'; e'; \tau$}
\RightLabel{($!$ I)}
\UIC{$\Gamma^{\bullet}; [e]_{\annotate{s}}^{\bnd{\bullet}} \underset{bnd.}{\implies} s
...
\AXC{$\Gamma^{\bullet}, x : \annotate{\tau_0}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma', x
...
\AXC{$
\begin{aligned}[t]
\Gamma^{\bullet}; f^{\bnd{\bullet}} &\underset{bnd.}{\implies} \Gamma'; f'; \forall
\epsilon_0, \ldots, \epsilon_n \ . \ \tau_0 \multimap \tau \\
\Gamma^{\bullet}; e^{\bnd{\bullet}} &\underset{bnd.}{\implies} \Theta; e'; \tau'_0 \\
\end{aligned} $}
\hskip 0.5em
\AXC{$\begin{aligned}[t]
...
% $}
\RightLabel{($\multimap$ E)}
\BIC{$\Gamma^{\bullet}; (f~e)^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma' +
...
\UIC{$\Gamma^{\bullet}; \textbf{op}^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma;
...
\RightLabel{(\textbf{factor})}
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma'; e'; (M_q
\tau_0 \times M_r \tau_1)$}
\UIC{$\Gamma^{\bullet}; \textbf{factor}~e^{\bnd{\bullet}} \underset{bnd.}{\implies}
...
\UIC{$\Gamma^{\bullet}; \textbf{ret}~e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma';
\textbf{ret}~e'; M_0~\tau$}
\bottomAlignProof
\DisplayProof
\hskip 0.5em
...
\UIC{$\Gamma^{\bullet}; \textbf{rnd}~e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma';
\textbf{rnd}~e'; M_q~\tau$}
\bottomAlignProof
\DisplayProof
\vskip 1em
...
%% times intro 
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma_0; e'; \tau_0$}
\AXC{$\Gamma^{\bullet}; f^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma_1; f'; \tau_1$}
% \AXC{$
% \begin{aligned}[t]
...
% $}
\RightLabel{($\times$ I)}
\BIC{$\Gamma^{\bullet}; \langle f, e \rangle^{\bnd{\bullet}} \underset{bnd.}{\implies}
\text{max}(\Gamma_0, \Gamma_1); \langle f', e' \rangle; \tau_0 \times \tau_1$}
% todo: check that max is defined
\bottomAlignProof
\DisplayProof
\RightLabel{($\times$ E)}
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma'; e'; \tau_0
\times \tau_1$}
\UIC{$\Gamma^{\bullet}; (\pi_i~e)^{\bnd{\bullet}} \underset{bnd.}{\implies}
\Gamma'; \pi_i~e'; \tau_i$}
\bottomAlignProof
\DisplayProof
\vskip 1em
...
%% otimes intro 
\AXC{$\Gamma^{\bullet}; f^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma_0; f'; \tau_1$}
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma_1; e'; \tau_0$}
\RightLabel{($\otimes$ I)}
\BIC{$\Gamma^{\bullet}; \langle f, e \rangle^{\bnd{\bullet}}
\underset{bnd.}{\implies} \Gamma_0 + \Gamma_1; (f', e'); \tau_0 \otimes \tau_1$}
\bottomAlignProof
\DisplayProof
\vskip 1em
...
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma'; e'; \tau_0$}
\AXC{$\Gamma^{\bullet}, x : \tau_0; f^{\bnd{\bullet}} \underset{bnd.}{\implies} \Theta, x :_s
\tau_0; f'; \tau$}
\BIC{$\Gamma^{\bullet}; (\textbf{let} \ x \ = \ e \ \textbf{in} \
f)^{\bnd{\bullet}} \underset{bnd.}{\implies} s \cdot \Gamma + \Theta;
...
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma'; e';
\tau_0 \otimes \tau_1$}
\AXC{$\Gamma^{\bullet}, x: \tau_0, y : \tau_1; f^{\bnd{\bullet}}
\underset{bnd.}{\implies} \Theta, x :_s \tau_0, y :_s' \tau_1; f'; \tau$}
\BIC{$\Gamma^{\bullet}; (\textbf{let-pair} \ (x, y) \ = \ e \ \textbf{in} \
f)^{\bnd{\bullet}} \underset{bnd.}{\implies} max(s, s') \cdot \Gamma' + \Theta;
...
\AXC{$\Gamma^{\bullet}; e^{\bnd{\bullet}} \underset{bnd.}{\implies} \Gamma'; e';
M_r~\tau_0$}
\AXC{$\Gamma^{\bullet}, x: \tau_0; f^{\bnd{\bullet}} \underset{bnd.}{\implies} \Theta, x
:_s \tau_0; f; M_q~\tau$}
...
\underset{bnd.}{\implies} \Theta_0, x :_s \tau_0; f'_1; \tau_0$}
\AXC{$\Gamma^{\bullet}, x : \tau_0 ; f_2^{\bnd{\bullet}}
\underset{bnd.}{\implies} \Theta_1, x :_s \tau_0; f'_2; \tau_1$}
\AXC{$s > 0$}
\QIC{$\Gamma^{\bullet}; (\textbf{case} \ e \ \textbf{of} \
(\textbf{in}_1~x.f_1 ~ | ~ \textbf{in}_2~x.f_2))^{\bnd{\bullet}}
\underset{bnd.}{\implies} s \cdot \Gamma + max(\Theta_0, \Theta_1); (\textbf{case} \ e' \ \textbf{of}
