...
In this case, we can extend the $\bnd{\llbracket - \rrbracket}$ mapping interval
expressions to concrete intervals to be over all types.
Note that for simplicity, we halt evaluation when we see a $\forall$.
