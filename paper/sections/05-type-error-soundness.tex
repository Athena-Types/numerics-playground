...
\begin{description}
  ...
  \item[\textsc{(ty. rule) $\multimap I$.}] We are given in our inductive
    ...
    \begin{description}
      ...
      \item{\underline{(ty. case) $\tau_0 \times \tau_1$.}} Holds by application
        of the inductive hypothesis. 
      \item{\underline{(ty. case) $\tau_0 \otimes \tau_1$.}} Holds by
        application of the inductive hypothesis.
      \item{\underline{(ty. case) $\tau_0 + \tau_1$.}} Holds by application of
        the inductive hypothesis.
      \item{\underline{(ty. case) $\tau_0 \multimap \tau_1$.}} Holds by
        application of the inductive hypothesis. 
