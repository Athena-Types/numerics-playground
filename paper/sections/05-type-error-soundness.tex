...
\textit{only} computing the overlined portions of the operational semantics
rewrite rules. Our unified operational semantics allows for both perspectives to
co-exist.
