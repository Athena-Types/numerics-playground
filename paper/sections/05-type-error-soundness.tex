...
\begin{proof}
  ...
  \begin{description}
    ...
    \item[Case rnd.] 
      ...
      \begin{description}
        \item[\underline{Property 1.}]
          Holds under the assumption the grade $q$ annotation of the rounding
          function is correct (Definition~\ref{def:numfuzz-interface}, property
          a) and application of our inductive hypothesis.
        \item[\underline{Property 2.}]
