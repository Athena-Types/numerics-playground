...
\begin{proof}
  ...
  \begin{description}
    \item[Var.] In the case that $s=1$, holds immediately. Otherwise, we apply
      weakening.
    \item[Immediate inductive caes: $\multimap$ E, $\times$ I, $\times$ E,
      $\otimes$ I, $+$ $I_i$, Widen, ! I, Subsumption, Factor, Ret, Rnd,
      $\forall$ E.]
      These cases follow immediately by application of the inductive hypothesis.
